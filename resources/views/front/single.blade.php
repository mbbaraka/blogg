                    ...
                    <div class="row pt-md-4">
                        ...
                        <div class="meta-wrap pt-2">
                            <p class="meta">
                                ...
                                <span><i class="icon-comment2 mr-2"></i>{{ $comments->count() }} @if($comments->count() <= 1) Comment @else Comments @endif</span>
                            </p>
                        </div>
                        <hr>
                        <p>
                        ...
                        <div class="pt-5 mt-5">
                            ...
                            @auth
                            <div class="comment-form-wrp pt-5">
